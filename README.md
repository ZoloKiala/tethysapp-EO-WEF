...
The EO-WEF  is a Tethys App that uses Google Earth Engine to visualize remotely sensed datasets for different components of the Water Energy Food (WEF) nexus.
