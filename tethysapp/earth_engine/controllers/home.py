...
def home(request, user_workspace):
    ...
    controls=[
        ...
        {'ZoomToExtent': {
            ...
            'extent': boundary_props.get('bbox', [32.70419004233669,-12.001795036314505,
            34.14065244468044,-12.001795036314505])
 #Default Songwe Basin River
        }}
    ],
    basemap=[
        'CartoDB',
    ...
    view=MVView(
        projection='EPSG:4326',
        center=boundary_props.get('centroid', [33.3016, -9.4807]), #Default Songwe Basin River
        zoom=boundary_props.get('zoom', 7),  # Default to Songwe Basin River
        maxZoom=18,
        minZoom=2
    ),
    draw=MVDraw(
